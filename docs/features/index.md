...
- **Evidence-driven vulnerability validation** — hypothesis testing,
  ...
  [Vulnerability Proof & PoC](/v7-vulnerability-proof-and-poc/).
- **Professional reporting** — findings, evidence bundles, remediation plans
  ...
  [Professional Reporting](/v7-professional-finding-intelligence-reporting/).
...
- **TIDB-backed persistence** — SQL storage with Alembic migrations, events,
  audit and versioning. See [Persistence (TIDB)](/v7-tidb/).
- **Security model** — scope and authorization guards, sandboxing, evidence-
  ...
  [Security Pipeline](/v7-security-pipeline/).
...
[Core Foundation](/v7-foundation/) and [Architecture Enforcement](/architecture/).
