---
layout: default
title: Agents — HunterX v6.0.0
keywords: HunterX Agents, Multi-Agent System, Autonomous Agents
description: >-
  HunterX v6.0.0 features a multi-agent platform with 10 specialized agents for reconnaissance, exploitation, and post-exploitation.
