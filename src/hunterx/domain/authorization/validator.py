...
"""Authorization observation validation.

Deterministic structural and semantic validation of authorization
...
class AuthorizationValidator:
    """Validate authorization observations before persistence.
    ...
    def validate(self, observation: Any) -> AuthorizationValidationResult:
    ...
    def validate_many(self, observations: Iterable[Any]) -> list[AuthorizationValidationResult]:
