...
INSTALL_METHODS: dict[str, tuple[InstallMethod, ...]] = {
    ...
    "urlfinder": (
        InstallMethod(kind="go", name="github.com/projectdiscovery/urlfinder@latest"),
    ),
    "spiderfoot": (
    ...
    "amass": (
        InstallMethod(kind="go", name="github.com/owasp-amass/amass/v4/...@master"),
    ...
    "gitleaks": (
        InstallMethod(kind="go", name="github.com/gitleaks/gitleaks/v8@latest"),
...
TOOL_BINARY_SPECS: dict[str, dict[str, object]] = {
    ...
    "assetfinder": {"executable": "assetfinder", "version_command": ("-version",), "version_regex": r"v?([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    ...
    "arjun": {"executable": "arjun", "version_command": ("--version",), "version_regex": r"v?([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    "paramspider": {"executable": "paramspider", "version_command": ("--version",), "version_regex": r"([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    ...
    "commix": {"executable": "commix", "version_command": ("--version",), "version_regex": r"v?([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    ...
    "tplmap": {"executable": "tplmap", "version_command": ("--version",), "version_regex": r"([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    "sstimap": {"executable": "sstimap", "version_command": ("--version",), "version_regex": r"v?([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    "graphqlmap": {"executable": "graphqlmap", "version_command": ("--version",), "version_regex": r"([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    "inql": {"executable": "inql", "version_command": ("--version",), "version_regex": r"([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
    ...
    "searchsploit": {"executable": "searchsploit", "version_command": ("--version",), "version_regex": r"v?([0-9]+\.[0-9]+(?:\.[0-9]+)?)"},
