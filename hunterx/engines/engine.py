...
from ..modules.payloads.payload_manager import PayloadRanker
from ..utils.utils import logger, setup_graceful_shutdown, is_shutting_down
from ..core.classifier import PayloadClassifier
from ..core.context import ContextEngine
from ..core.waf import WAFDetect
from ..core.trace import TraceLogger
from ..core.profiles import get_profile
from ..core.passive import PassiveIntel
from ..core.reasoning_engine_old import ReasoningEngine
from ..reporting.visualizer import SimpleVisualizer
from ..core.memory import SessionMemory
from ..core.impact import ImpactAnalyzer
from ..core.oob import OOBDetector, OOBConfig
from ..core.time_based import TimeBasedDetector
from ..core.html_analyzer import HTMLAnalyzer
from ..core.mutation_engine import MutationEngine
from ..utils.plugin_loader import PluginLoader
from ..core.ai import LLMAnalyzer, AnomalyCluster
...
from ..modules.intelligence.attack_chain import AttackChainEngine
from ..modules.intelligence.threat_model import ThreatModelEngine
from ..modules.intelligence.relationship import RelationshipEngine
from ..modules.intelligence.evolution import PayloadEvolutionEngine
from ..modules.intelligence.adaptive_memory import AdaptiveMemory
from ..core.planner import Planner
from ..reporting.visual_graph import VisualAttackGraph
from ..modules.intelligence.browser_intelligence import BrowserIntelligenceEngine
from ..modules.intelligence.explainability import ExplainabilityEngine
...
class Engine:
    def __init__(self, target_url: str, payloads: Iterable[Dict], options: Dict = None):
