...
class LearningAgent(SecurityAgent):
    def __init__(self, agent_id: str = ""):
        super().__init__(agent_id=agent_id, name="LearningAgent", version="1.0.0")
        self._capabilities = [AgentCapability.LEARNING]
    ...
    def _on_create_goals(self, objective: str, context: Dict[str, Any]) -> List[Goal]:
        return [
            Goal.create(
                ...
                objective=f"Learning: {objective}",
                context=context,
